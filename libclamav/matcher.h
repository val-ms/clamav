 ...
 *
 * @param root              May be used for the mempool (if enabled) to allocate a new offset_data structure.
 ...
 * @return cl_error_t
 */
cl_error_t matcher_decode_offset_string(struct cli_matcher *root, const char *offstr, cli_target_t target, pattern_offset_data **offset_data);
