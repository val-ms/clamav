...
typedef struct recursion_level_tag {
    ...
    size_t entity_id;                     /* Unique ID for this entity. */
...
typedef struct cli_ctx_tag {
    ...
    size_t entity_count;                /* Counter for number of unique entities/contained files (including normalized files) processed. */
