...
class TC(testcase.TestCase):
    ...
    def test_xls_jpeg_png(self):
        ...
        expected_results = [
            ...
            '"FileSHA256":"4b947f2c5a9bff880100adc319690ab0da05792951e7355d76dfee1da17bb674"',
            '"FileSHA256":"b5c25a21cb9a59489c0629a14a06b492181d166c956e4244bb3da91476f39ecf"',
        ]
    ...
    def test_HTML_style_with_detection(self):
        ...
        expected_stderr = [
            'Recognized GIF file',
            'Recognized PNG file',
            '"FileSHA256":"e559f8ea2867eb925d4fd3472129f455832912eb5dd5adc3769ea9138d6d9f0c"',
            '"FileSHA256":"b80f890d19ccb36dae6cf9e62c56013ea9988f763ac3ca86f74539303b091f6b"',
        ]
        self.verify_output(output.err, expected=expected_stderr)
