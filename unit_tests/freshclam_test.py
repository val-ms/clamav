...
class TC(testcase.TestCase):
    ...
    def test_freshclam_02_http_403(self):
        ...
        TC.mock_mirror = Process(target=mock_database_mirror)
    ...
    def test_freshclam_02_http_403_daemonized(self):
    ...
    def test_freshclam_03_http_429(self):
